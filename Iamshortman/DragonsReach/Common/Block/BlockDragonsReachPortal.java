...
import Iamshortman.DragonsReach.Common.World.TeleporterDragonsReach;
	...
	public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
	{
		if (par5Entity.ridingEntity == null && par5Entity.riddenByEntity == null)
		{
			if (par5Entity instanceof EntityPlayerMP)
			{
				...
				if (par5Entity.dimension != DragonsReachMod.dimension)
				{
					thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, DragonsReachMod.dimension, new TeleporterDragonsReach(thePlayer.mcServer.worldServerForDimension(DragonsReachMod.dimension)));
					System.out.println("Taking " + thePlayer.username + " to the Dragon's Reach");
					//thePlayer.playerNetServerHandler.setPlayerLocation(0, 100, 0, thePlayer.rotationYaw, thePlayer.rotationPitch);
				}
				else
				{
					thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new TeleporterDragonsReach(thePlayer.mcServer.worldServerForDimension(0)));
				}
			}
		}
	}
