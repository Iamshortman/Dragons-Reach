...
public class ChunkProviderTesting implements IChunkProvider
{
	/** RNG. */
	private Random rand;
	...
	public ChunkProviderTesting(World par1World, long par2, boolean par4)
	{
				...
				for (int k1 = 127; k1 >= 0; --k1)
				{
					...
					else if (b3 == Block.stone.blockID)
					{
						if (j1 == -1)
						{
							...
							else if (k1 >= WaterLevel - 4 && k1 <= WaterLevel + 1)
							{
								b1 = biomegenbase.topBlock;
								b2 = biomegenbase.fillerBlock;
							}

							if (k1 < WaterLevel && b1 == 0)
							{
								if (f < 0.15F)
								{
